...
'''
This script is to calculate the average of 10 times 10-fold CVs (note not the average of one 10-fold CVs).
...
This process of 10 iterations of training and validation is called a 10-fold cross validation once.
